...
<template>
      ...
      <main>
        <div class="about-me">
            ...
            <p>Je m'appelle Mathieu Barbey. Je suis un étudiant fraichement diplômé d'un master en science de la Terre et des planètes au cours duquel j'ai pu ,au travers
              mes stages, développé un attrait pour la programmation et la modélisation numérique. Suite à l'obtiention de mon diplôme,
          ...
          <div  class="creation">
              ...
              <img @click="openModal(modals.cv)" src="./assets/img/cv.png" alt="">
                  <Modal v-if="modals.cv.visible" @modal-close="closeModal(modals.cv)" name="first-modal">
                    ...
                    <template class="modal" #content>
                      ...
                      <p>Repository Github: <a href="https://github.com/matiti61290/CV-HTML-Formation" target="_blank">https://github.com/matiti61290/CV-HTML-Formation</a></p>
                    </template>
            ...
            <div class="creation-detail">
              ...
              <Modal v-if="modals.cc.visible" @modal-close="closeModal(modals.cc)" name="second-modal">
                ...
                <template #content>
                  <p>Créé le: 2 décembre 2023</p>
                  <p>Lien PDF: <a href="./pdf/cahierDesCharges.pdf" target="_blank">Cahier des charges La Socketterie</a></p>
                </template>
                <template class="modal" #footer></template>
              </Modal>
            </div>
            <div class="creation-detail">
              ...
              <Modal v-if="modals.comm.visible" @modal-close="closeModal(modals.comm)" name="third-modal">
                ...
                <template #content>
                  ...
                  <p>Lien PDF: <a href="https://github.com/matiti61290/Form-JS-Formation" target="_blank">Exemple de dynamisation d'un espace de commentaire</a></p>
                </template>
